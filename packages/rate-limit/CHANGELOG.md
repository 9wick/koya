...
## [0.6.0](https://github.com/zeltjs/zelt/compare/rate-limit-v0.5.0...rate-limit-v0.6.0) (2026-05-17)
...
* The following workspace dependencies were updated
  * devDependencies
    ...
    * @zeltjs/validator-valibot bumped to 0.6.0
  * peerDependencies
    * @zeltjs/core bumped to 0.6.0
    * @zeltjs/kv bumped to 0.6.0

## [0.5.0](https://github.com/zeltjs/zelt/compare/rate-limit-v0.4.0...rate-limit-v0.5.0) (2026-05-17)
...
* The following workspace dependencies were updated
  * devDependencies
    ...
    * @zeltjs/validator-valibot bumped to 0.5.0
  * peerDependencies
    * @zeltjs/core bumped to 0.5.0
    * @zeltjs/kv bumped to 0.5.0

## [0.4.0](https://github.com/zeltjs/zelt/compare/rate-limit-v0.3.0...rate-limit-v0.4.0) (2026-05-17)
...
* The following workspace dependencies were updated
  * devDependencies
    ...
    * @zeltjs/validator-valibot bumped to 0.4.0
  * peerDependencies
    * @zeltjs/core bumped to 0.4.0
    * @zeltjs/kv bumped to 0.4.0
